 ...
 */
final class Version20230412122453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prospect (id INT AUTO_INCREMENT NOT NULL, autor_id INT DEFAULT NULL, comrcl_id INT DEFAULT NULL, team_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, gender SMALLINT DEFAULT NULL, city VARCHAR(255) NOT NULL, adress LONGTEXT DEFAULT NULL, brith_at DATETIME NOT NULL, source VARCHAR(50) NOT NULL, type_prospect VARCHAR(50) DEFAULT NULL, raison_sociale VARCHAR(255) DEFAULT NULL, code_post INT DEFAULT NULL, gsm VARCHAR(255) NOT NULL, assure VARCHAR(20) DEFAULT NULL, last_assure VARCHAR(20) DEFAULT NULL, motif_resil VARCHAR(50) DEFAULT NULL, motif_saise VARCHAR(255) DEFAULT NULL, creat_at DATETIME NOT NULL, INDEX IDX_C9CE8C7D14D45BBE (autor_id), INDEX IDX_C9CE8C7D10C5C333 (comrcl_id), INDEX IDX_C9CE8C7D296CD8AE (team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
